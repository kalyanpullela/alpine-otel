...
#ifndef __LDH_STRUCTS_IPD_V4_H__
#define __LDH_STRUCTS_IPD_V4_H__
...
typedef struct {
    ...
    uint8_t format_f : 1;
    uint8_t rsvd0_f : 5;
    uint8_t copy_cnt_f : 3;
} ldh_base_hdr_format_t;

#define LDH_BASE_HDR_FORMAT_SIZE 4

static inline void pack_ldh_base_hdr_format(ldh_base_hdr_format_t *val, uint8_t *packed)
{
    memset(packed, 0, 4);
    packed[0] |= (val->ver_f & 0xf) << 4;
    packed[0] |= (val->rsvd1_f & 0x78000) >> 15;
    packed[1] |= (val->rsvd1_f & 0x7f80) >> 7;
    packed[2] |= (val->rsvd1_f & 0x7f) << 1;
    packed[2] |= (val->format_f & 0x1) << 0;
    packed[3] |= (val->rsvd0_f & 0x1f) << 3;
    packed[3] |= (val->copy_cnt_f & 0x7) << 0;
}

static inline void unpack_ldh_base_hdr_format(uint8_t *packed, ldh_base_hdr_format_t *val)
{
    val->ver_f = (((uint8_t) (packed[0] & 0xf0)) >> 4);
    val->rsvd1_f = (((uint32_t) (packed[0] & 0xf)) << 15) |
        (((uint32_t) (packed[1] & 0xff)) << 7) |
        (((uint32_t) (packed[2] & 0xfe)) >> 1);
    val->format_f = (((uint8_t) (packed[2] & 0x1)) >> 0);
    val->rsvd0_f = (((uint8_t) (packed[3] & 0xf8)) >> 3);
    val->copy_cnt_f = (((uint8_t) (packed[3] & 0x7)) >> 0);
}
...
typedef struct {
 /*  */
    ...
    uint8_t vf_type_f : 3;
    uint8_t _rsvd_fixed_10_f : 1;
    uint8_t _rsvd_fixed_11_f : 1;
    uint8_t version_f : 2;
    uint8_t _rsvd_fixed_13_f : 1;
    uint8_t _rsvd_fixed_14_f : 1;
} ldh_fixed_format_t;
...
static inline void pack_ldh_fixed_format(ldh_fixed_format_t *val, uint8_t *packed)
{
    ...
    packed[2] |= (val->_rsvd_fixed_10_f & 0x1) << 5;
    packed[2] |= (val->_rsvd_fixed_11_f & 0x1) << 4;
    packed[2] |= (val->version_f & 0x3) << 2;
    packed[2] |= (val->_rsvd_fixed_13_f & 0x1) << 1;
    packed[2] |= (val->_rsvd_fixed_14_f & 0x1) << 0;
}
...
static inline void unpack_ldh_fixed_format(uint8_t *packed, ldh_fixed_format_t *val)
{
    ...
    val->_rsvd_fixed_10_f = (uint8_t) (((uint8_t) (packed[2] & 0x20)) >> 5);
    val->_rsvd_fixed_11_f = (uint8_t) (((uint8_t) (packed[2] & 0x10)) >> 4);
    val->version_f = (uint8_t) (((uint8_t) (packed[2] & 0xc)) >> 2);
    val->_rsvd_fixed_13_f = (uint8_t) (((uint8_t) (packed[2] & 0x2)) >> 1);
    val->_rsvd_fixed_14_f = (uint8_t) (((uint8_t) (packed[2] & 0x1)) >> 0);
}

typedef struct {
 /*  */
    uint16_t _rsvd_vf0_0_f : 9;
    uint16_t slp_f : 11;
...
{
    val->slp_f = (uint16_t) (((uint16_t) (packed[1] & 0x7f)) << 4) |
...
typedef struct {
 /*  */
    ...
    uint8_t _rsvd_vf1_4_f : 1;
    uint8_t _rsvd_vf1_5_f : 1;
    uint8_t system_qos_f : 6;
    uint8_t _rsvd_vf1_7_f : 1;
    uint16_t ssp_f : 11;
    uint8_t _rsvd_vf1_9_f : 7;
    uint8_t _rsvd_vf1_10_f : 1;
    uint32_t _rsvd_vf1_11_f : 24;
    uint64_t _rsvd_vf1_12_f : 64;
} ldh_vf1_format_t;
...
static inline void pack_ldh_vf1_format(ldh_vf1_format_t *val, uint8_t *packed)
{
    ...
    packed[2] |= (val->_rsvd_vf1_5_f & 0x1) << 2;
    packed[2] |= (val->system_qos_f & 0x30) >> 4;
    packed[3] |= (val->system_qos_f & 0xf) << 4;
    packed[3] |= (val->ssp_f & 0x700) >> 8;
    packed[4] |= (val->ssp_f & 0xff) << 0;
    packed[5] |= (val->_rsvd_vf1_10_f & 0x1) << 0;
    packed[9] |= (val->_rsvd_vf1_12_f & 0xff00000000000000) >> 56;
    packed[10] |= (val->_rsvd_vf1_12_f & 0xff000000000000) >> 48;
    packed[11] |= (val->_rsvd_vf1_12_f & 0xff0000000000) >> 40;
    packed[12] |= (val->_rsvd_vf1_12_f & 0xff00000000) >> 32;
    packed[13] |= (val->_rsvd_vf1_12_f & 0xff000000) >> 24;
    packed[14] |= (val->_rsvd_vf1_12_f & 0xff0000) >> 16;
    packed[15] |= (val->_rsvd_vf1_12_f & 0xff00) >> 8;
    packed[16] |= (val->_rsvd_vf1_12_f & 0xff) << 0;
}
...
static inline void unpack_ldh_vf1_format(uint8_t *packed, ldh_vf1_format_t *val)
{
    ...
    val->_rsvd_vf1_5_f = (uint8_t) (((uint8_t) (packed[2] & 0x4)) >> 2);
    val->system_qos_f = (uint8_t) (((uint8_t) (packed[2] & 0x3)) << 4) |
        (uint8_t) (((uint8_t) (packed[3] & 0xf0)) >> 4);
    val->ssp_f = (uint16_t) (((uint16_t) (packed[3] & 0x7)) << 8) |
        (uint16_t) (((uint16_t) (packed[4] & 0xff)) >> 0);
    val->_rsvd_vf1_10_f = (uint8_t) (((uint8_t) (packed[5] & 0x1)) >> 0);
    val->_rsvd_vf1_12_f = (((uint64_t) (packed[9] & 0xff)) << 56) |
...
typedef struct {
 /*  */
    ...
    uint8_t _rsvd_vf2_1_f : 8;
    uint8_t _rsvd_vf2_2_f : 4;
    uint8_t _rsvd_vf2_3_f : 4;
    uint8_t _rsvd_vf2_4_f : 5;
    uint8_t _rsvd_vf2_5_f : 3;
    uint8_t _rsvd_vf2_6_f : 6;
    uint8_t _rsvd_vf2_7_f : 2;
    uint8_t _rsvd_vf2_8_f : 3;
    uint8_t _rsvd_vf2_9_f : 1;
    uint8_t _rsvd_vf2_10_f : 4;
    uint8_t _rsvd_vf2_11_f : 1;
    uint8_t _rsvd_vf2_12_f : 5;
    uint8_t _rsvd_vf2_13_f : 1;
    uint8_t _rsvd_vf2_14_f : 1;
    uint8_t _rsvd_vf2_15_f : 5;
    uint16_t _rsvd_vf2_16_f : 11;
    uint64_t _rsvd_vf2_17_f : 64;
} ldh_vf2_format_t;
...
{
    memset(packed, 0, 17);
    packed[1] |= (val->_rsvd_vf2_1_f & 0xff) << 0;
    packed[2] |= (val->_rsvd_vf2_3_f & 0xf) << 0;
    packed[3] |= (val->_rsvd_vf2_5_f & 0x7) << 0;
    packed[4] |= (val->_rsvd_vf2_7_f & 0x3) << 0;
    packed[5] |= (val->_rsvd_vf2_9_f & 0x1) << 4;
    packed[5] |= (val->_rsvd_vf2_10_f & 0xf) << 0;
    packed[6] |= (val->_rsvd_vf2_11_f & 0x1) << 7;
    packed[6] |= (val->_rsvd_vf2_13_f & 0x1) << 1;
    packed[6] |= (val->_rsvd_vf2_14_f & 0x1) << 0;
    packed[7] |= (val->_rsvd_vf2_16_f & 0x700) >> 8;
    packed[8] |= (val->_rsvd_vf2_16_f & 0xff) << 0;
}

static inline void unpack_ldh_vf2_format(uint8_t *packed, ldh_vf2_format_t *val)
{
    val->_rsvd_vf2_1_f = (uint8_t) (((uint8_t) (packed[1] & 0xff)) >> 0);
    val->_rsvd_vf2_3_f = (uint8_t) (((uint8_t) (packed[2] & 0xf)) >> 0);
    val->_rsvd_vf2_5_f = (uint8_t) (((uint8_t) (packed[3] & 0x7)) >> 0);
    val->_rsvd_vf2_7_f = (uint8_t) (((uint8_t) (packed[4] & 0x3)) >> 0);
    val->_rsvd_vf2_9_f = (uint8_t) (((uint8_t) (packed[5] & 0x10)) >> 4);
    val->_rsvd_vf2_10_f = (uint8_t) (((uint8_t) (packed[5] & 0xf)) >> 0);
    val->_rsvd_vf2_11_f = (uint8_t) (((uint8_t) (packed[6] & 0x80)) >> 7);
    val->_rsvd_vf2_13_f = (uint8_t) (((uint8_t) (packed[6] & 0x2)) >> 1);
    val->_rsvd_vf2_14_f = (uint8_t) (((uint8_t) (packed[6] & 0x1)) >> 0);
    val->_rsvd_vf2_16_f = (uint16_t) (((uint16_t) (packed[7] & 0x7)) << 8) |
        (uint16_t) (((uint16_t) (packed[8] & 0xff)) >> 0);
}
...
static inline void unpack_ldh_vf0(uint8_t *packed, ldh_vf0_t *val)
{
    ...
    val->_rsvd_fixed_13_f = (uint8_t) (((uint8_t) (packed[2] & 0x2)) >> 1);
    val->_rsvd_fixed_14_f = (uint8_t) (((uint8_t) (packed[2] & 0x1)) >> 0);
    val->slp_f = (uint16_t) (((uint16_t) (packed[4] & 0x7f)) << 4) |
...
static inline void pack_ldh_vf1(ldh_vf1_t *val, uint8_t *packed)
{
    ...
    packed[5] |= (val->_rsvd_vf1_5_f & 0x1) << 2;
    packed[5] |= (val->system_qos_f & 0x30) >> 4;
    packed[6] |= (val->system_qos_f & 0xf) << 4;
    packed[6] |= (val->ssp_f & 0x700) >> 8;
    packed[7] |= (val->ssp_f & 0xff) << 0;
    packed[8] |= (val->_rsvd_vf1_10_f & 0x1) << 0;
    packed[12] |= (val->_rsvd_vf1_12_f & 0xff00000000000000) >> 56;
    packed[13] |= (val->_rsvd_vf1_12_f & 0xff000000000000) >> 48;
    packed[14] |= (val->_rsvd_vf1_12_f & 0xff0000000000) >> 40;
    packed[15] |= (val->_rsvd_vf1_12_f & 0xff00000000) >> 32;
    packed[16] |= (val->_rsvd_vf1_12_f & 0xff000000) >> 24;
    packed[17] |= (val->_rsvd_vf1_12_f & 0xff0000) >> 16;
    packed[18] |= (val->_rsvd_vf1_12_f & 0xff00) >> 8;
    packed[19] |= (val->_rsvd_vf1_12_f & 0xff) << 0;
}
...
static inline void unpack_ldh_vf1(uint8_t *packed, ldh_vf1_t *val)
{
    ...
    val->_rsvd_vf1_5_f = (uint8_t) (((uint8_t) (packed[5] & 0x4)) >> 2);
    val->system_qos_f = (uint8_t) (((uint8_t) (packed[5] & 0x3)) << 4) |
        (uint8_t) (((uint8_t) (packed[6] & 0xf0)) >> 4);
    val->ssp_f = (uint16_t) (((uint16_t) (packed[6] & 0x7)) << 8) |
        (uint16_t) (((uint16_t) (packed[7] & 0xff)) >> 0);
    val->_rsvd_vf1_10_f = (uint8_t) (((uint8_t) (packed[8] & 0x1)) >> 0);
    val->_rsvd_vf1_12_f = (((uint64_t) (packed[12] & 0xff)) << 56) |
...
static inline void pack_ldh_vf2(ldh_vf2_t *val, uint8_t *packed)
{
    ...
    packed[2] |= (val->_rsvd_fixed_13_f & 0x1) << 1;
    packed[2] |= (val->_rsvd_fixed_14_f & 0x1) << 0;
    packed[4] |= (val->_rsvd_vf2_1_f & 0xff) << 0;
    packed[5] |= (val->_rsvd_vf2_3_f & 0xf) << 0;
    packed[6] |= (val->_rsvd_vf2_5_f & 0x7) << 0;
    packed[7] |= (val->_rsvd_vf2_7_f & 0x3) << 0;
    packed[8] |= (val->_rsvd_vf2_9_f & 0x1) << 4;
    packed[8] |= (val->_rsvd_vf2_10_f & 0xf) << 0;
    packed[9] |= (val->_rsvd_vf2_11_f & 0x1) << 7;
    packed[9] |= (val->_rsvd_vf2_13_f & 0x1) << 1;
    packed[9] |= (val->_rsvd_vf2_14_f & 0x1) << 0;
    packed[10] |= (val->_rsvd_vf2_16_f & 0x700) >> 8;
    packed[11] |= (val->_rsvd_vf2_16_f & 0xff) << 0;
}
...
static inline void unpack_ldh_vf2(uint8_t *packed, ldh_vf2_t *val)
{
    ...
    val->_rsvd_fixed_13_f = (uint8_t) (((uint8_t) (packed[2] & 0x2)) >> 1);
    val->_rsvd_fixed_14_f = (uint8_t) (((uint8_t) (packed[2] & 0x1)) >> 0);
    val->_rsvd_vf2_1_f = (uint8_t) (((uint8_t) (packed[4] & 0xff)) >> 0);
    val->_rsvd_vf2_3_f = (uint8_t) (((uint8_t) (packed[5] & 0xf)) >> 0);
    val->_rsvd_vf2_5_f = (uint8_t) (((uint8_t) (packed[6] & 0x7)) >> 0);
    val->_rsvd_vf2_7_f = (uint8_t) (((uint8_t) (packed[7] & 0x3)) >> 0);
    val->_rsvd_vf2_9_f = (uint8_t) (((uint8_t) (packed[8] & 0x10)) >> 4);
    val->_rsvd_vf2_10_f = (uint8_t) (((uint8_t) (packed[8] & 0xf)) >> 0);
    val->_rsvd_vf2_11_f = (uint8_t) (((uint8_t) (packed[9] & 0x80)) >> 7);
    val->_rsvd_vf2_13_f = (uint8_t) (((uint8_t) (packed[9] & 0x2)) >> 1);
    val->_rsvd_vf2_14_f = (uint8_t) (((uint8_t) (packed[9] & 0x1)) >> 0);
    val->_rsvd_vf2_16_f = (uint16_t) (((uint16_t) (packed[10] & 0x7)) << 8) |
        (uint16_t) (((uint16_t) (packed[11] & 0xff)) >> 0);
}
...
#endif /* __LDH_STRUCTS_IPD_V4_H__ */
